...
TELEGRAM_BOT_TOKEN = '7406121925:AAERj94FToq8R2myht8dDjm2c0FHC8gGDe0'
ADMIN_USER_ID = 1464703207
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our OWNERRUTVIK service!*", parse_mode='Markdown')
